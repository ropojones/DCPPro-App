...
{
    public abstract class DcpproWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DcpproWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DcpproWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DcpproDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DcpproDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DcpproDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DcpproDbContext, Task<T>> func)
        {
            T result;
